  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        disabled={disabled}
        className="w-full px-3 py-1 pr-8 border border-footer-border rounded-lg text-xs leading-[2em] text-footer-text font-normal font-poppins bg-white outline-none cursor-pointer focus:border-primary-blue disabled:opacity-50 disabled:cursor-not-allowed text-left flex items-center justify-between"
      >
            ...
            return (
              <div key={option.value} className="bg-primary-blue/10">
                <button
                  ...
                  className={`w-full px-3 py-2 text-left text-xs leading-[2em] font-poppins transition-colors cursor-pointer ${
                    isSelected
